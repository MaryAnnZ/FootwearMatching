...
Qualitative evaluation indicates that the processed images are clearer, the shoeprints are sharper and the noice is reduced. 
Quantitative analysis using three basic image descriptors confirmed this and showed a higher accurary of up to 30\% in the enhanced images compared to their original. 
...
The shoeprint impressions of Figure \ref{fig:int:varying:3} and \ref{fig:int:varying:20} were made on an even surface whereas on Figure \ref{fig:int:varying:17} and \ref{fig:int:varying:25} cluttered background is visible caused by the surface properties. %which properties?
