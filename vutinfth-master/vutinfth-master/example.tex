...
Furthermore, there is limited knowledge available about preprocessing and enhancement techniques, to increase the matching accuracy.
\par
...
\par
The aim of this work is to give an overview about the current state of the art and to define an approach which is able to filter and enhance the shoeprint despite the presence of noise and varying image quality.
...
& BF & FLANN & BF & FLANN & BF & FLANN & \\
\specialrule{2.5pt}{1pt}{1pt}
Baseline & 5.66 & 5.24 & 6.03 & 5.47 & 7.80 & 7.07 & \multirow{2}{*}{ 6.21 } \\
& \multicolumn{2}{c|}{ 5.45 } & \multicolumn{2}{c|}{ 5.75 } & \multicolumn{2}{c?}{ 7.44 } & \\
\specialrule{1.1pt}{1pt}{1pt}
25 Average & 4.47 & 4.40 & 4.13 & 5.27 & 3.73 & 4.20 & \multirow{2}{*}{ 4.37 } \\
& \multicolumn{2}{c|}{ 4.43 } & \multicolumn{2}{c|}{ 4.70 } & \multicolumn{2}{c?}{ 3.97 } & \\
\hline
25 Centroids & 3.93 & 3.87 & 4.20 & 4.87 & 4.20 & 5.07 & \multirow{2}{*}{ 4.36 } \\
& \multicolumn{2}{c|}{ 3.90 } & \multicolumn{2}{c|}{ 4.53 } & \multicolumn{2}{c?}{ 4.63 } & \\
\hline
20 Average & 5.00 & 5.13 & 4.80 & 4.93 & 2.87 & 3.33 & \multirow{2}{*}{ 4.34 } \\
& \multicolumn{2}{c|}{ 5.07 } & \multicolumn{2}{c|}{ 4.87 } & \multicolumn{2}{c?}{ 3.10 } & \\
\hline
20 Centorids & 3.93 & 3.73 & 4.33 & 5.40 & 3.53 & 4.27 & \multirow{2}{*}{ 4.20 } \\
& \multicolumn{2}{c|}{ 3.83 } & \multicolumn{2}{c|}{ 4.87 } & \multicolumn{2}{c?}{ 3.90 } & \\
\end{tabular}
\captionof{table}{Overview about the performance of the analyzed pipelines}
 \label{tab:ov} 
%\end{sidewaystable}
